...
import { ArrowRight, FileText, CheckCircle, BarChart, ArrowDown } from "lucide-react"
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                ...
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">
                  Land Your Dream Job with <span className="text-gradient">HireLens</span>
                </h1>

                <p className="mx-auto max-w-[700px] text-muted-foreground text-lg md:text-xl">
                  Optimize your resume for ATS systems and increase your interview chances with our AI-powered resume
                  analyzer.
                </p>
                ...
                <div className="pt-12 pb-8">
                  ...
                  >
                    <Link href="#upload-section" className="text-muted-foreground hover:text-primary transition-colors">
                      <ArrowDown size={24} />
        ...
        {/* Upload Section */}
        <section id="upload-section" className="w-full py-16 md:py-24 section-bg-primary">
          <div className="container px-4 md:px-6">
            ...
            >
              <div className="space-y-4">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Analyze Your Resume Now</h2>
                <p className="mx-auto max-w-[600px] text-muted-foreground text-lg">
                  Upload your resume to get personalized feedback and suggestions to improve your chances of landing
                  interviews.
                </p>
              </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            >
              <div className="bg-card rounded-lg p-6 shadow-sm border border-border">
                ...
                <p className="text-muted-foreground">Upload your resume in PDF format for our AI to analyze.</p>
              </div>
              ...
              <div className="bg-card rounded-lg p-6 shadow-sm border border-border">
                ...
                <h3 className="text-xl font-bold mb-2">2. Add Job Description</h3>
                <p className="text-muted-foreground">Paste or upload the job description you're applying for.</p>
              </div>
        ...
        {/* Features Section */}
        <section id="features" className="w-full py-16 md:py-24 section-bg-accent">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              {[
                {
                  ...
                  icon: <CheckCircle size={24} className="text-color-success" />,
                },
                {
                  title: "Keyword Optimization",
                  description: "Identify missing keywords from the job description to increase your match rate.",
                  icon: <FileText size={24} className="text-color-primary" />,
                },
                {
                  title: "Format Improvement",
                  description: "Get suggestions to improve your resume format for better readability and ATS parsing.",
                  icon: <FileText size={24} className="text-color-secondary" />,
                },
                {
                  title: "Skills Gap Analysis",
                  description: "Identify skills mentioned in the job description that are missing from your resume.",
                  icon: <BarChart size={24} className="text-color-warning" />,
                },
                {
                  title: "Content Enhancement",
                  description: "Receive suggestions to strengthen your resume content with quantifiable achievements.",
        ...
        <section className="w-full py-16 md:py-24 section-bg-primary">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Ready to Land Your Dream Job?</h2>
